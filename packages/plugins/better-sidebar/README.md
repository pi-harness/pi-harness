...
Tree scans use Workspace Navigator's bounded traversal at depth 2 with at most 80 nodes and a five-second cache. Git status is refreshed for each new scan; complete change counts survive the 12-entry data preview and eight-row rendered panel. Returned tool and panel snapshots are detached.

  ...
  test("returns model-visible provenance, relations and node continuation", async () => {
    ...
    try {
      ...
      expect(report).toMatchObject({
        total: 2, offset: 0, nextOffset: 1, nodesTruncated: true, relationsTotal: 1, relationsTruncated: false,

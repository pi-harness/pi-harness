...
import { listSessionBookmarks, normalizeBookmarkLabel } from "../src/plugins/session-bookmarks.js";
import sessionBookmarksPlugin from "../src/plugins/session-bookmarks.js";

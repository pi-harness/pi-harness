...
declare module "@deepseek-ai/cordis" { interface Context { clientRoot: HTMLElement; clientApi: ClientApi; } }
...
export class AppWebEntry {
  ...
  async dispose(): Promise<void> { this.#reactRoot?.unmount(); await this.context.fiber.dispose(); }
}

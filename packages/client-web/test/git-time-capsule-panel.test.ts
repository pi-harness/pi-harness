...
test("does not invent zero-file completion metadata for cancelled restore", () => {
  const html = renderToStaticMarkup(createElement(PluginPanelCard, { panel: {
    id: "git-time-capsule-panel", pluginId: "@pi-harness/plugin-git-time-capsule", title: "Git Time Capsule",
    data: {
      latest: { action: "restore", status: "cancelled", at: "2026-09-10T12:00:00.000Z", error: "Inspect the workspace before retrying." },
      capsules: [], inventory: { total: 0, shown: 0, truncated: false, displayLimit: 20 }, timeoutMs: 15000,

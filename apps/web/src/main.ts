...
// run() now waits on the translation catalog, so a failure arrives as a rejected promise rather than a throw and a plain try/catch would let the page stay blank.
